...
class TestMigrationContext_AddTransforms(unittest.TestCase):
    ...
    def test_hardcoded_node(self):
        ...
        self.assertSetEqual(
            self.ctx.dependencies[("aboutDownloads.ftl", "about")], set()
        )
        self.assertTrue(
            self.ctx.in_changeset(set(), set(), "aboutDownloads.ftl", "about")
        )
    ...
    def test_no_reference(self):
        ...
        self.assertEqual(
            id(self.ctx.reference_resources.get("aboutDownloads.ftl")), id(ref_ast)
        )
...
class TestMigrationContext(unittest.TestCase):
    ...
    def test_merge_two_changesets(self):
        ...
        changeset_b = {("aboutDownloads.dtd", "aboutDownloads.header")}
    ...
    def test_bilingual_translated(self):
        self.ctx.add_transforms(
            ...
            [
                FTL.Message(
                    ...
                    value=COPY("bilingual.po", ("translated", None)),
                ),
            ],
        )
        expected = {
        ...
        self.assertDictEqual(to_json(self.ctx.merge_changeset(None)), expected)
        ...
        self.ctx.add_transforms(
            ...
            [
                FTL.Message(
                    ...
                    value=COPY("bilingual.po", ("untranslated", None)),
                ),
            ],
        )
        expected = {}
    ...
    def test_missing_file(self):
        self.ctx.add_transforms(
            ...
            [
                ...
                FTL.Message(
                    id=FTL.Identifier("header"), value=COPY("missing.dtd", "missing")
                ),
            ],
        )
    ...
    def test_all_files_missing(self):
        ...
        with self.assertRaisesRegex(EmptyLocalizationError, pattern):
            self.ctx.add_transforms(
                ...
                [
                    FTL.Message(
                        id=FTL.Identifier("foo"), value=COPY("missing.dtd", "foo")
                    ),
                ],
            )
    ...
    def test_missing_string_in_simple_value(self):
        self.ctx.add_transforms(
            ...
            [
                FTL.Message(
                    id=FTL.Identifier("title"),
                    value=COPY("aboutDownloads.dtd", "missing"),
                ),
            ],
        )

        self.assertDictEqual(to_json(self.ctx.merge_changeset()), {})
                        ...
                        FTL.SelectExpression(
                            ...
                            variants=[
                                FTL.Variant(
                                    ...
                                    default=False,
                                    value=COPY("aboutDownloads.dtd", "missing.windows"),
                                ),
                                FTL.Variant(
                                    key=FTL.Identifier("other"),
                                    default=True,
                                    value=COPY("aboutDownloads.dtd", "missing.other"),
                                ),
                            ],
                        ),
                    ),
        ...
        self.ctx.add_transforms(
            ...
            [
                FTL.Message(
                    ...
                    attributes=[
                        FTL.Attribute(
                            FTL.Identifier("one"), COPY("aboutDownloads.dtd", "missing")
                        ),
                    ],
                ),
            ],
            ...
            [
                FTL.Message(
                    ...
                    attributes=[
                        FTL.Attribute(
                            FTL.Identifier("one"),
                            COPY("aboutDownloads.dtd", "missing.one"),
                        ),
                        FTL.Attribute(
                            FTL.Identifier("two"),
                            COPY("aboutDownloads.dtd", "missing.two"),
                        ),
                    ],
                ),
            ],
                ...
                FTL.Message(
                    ...
                    attributes=[
                        FTL.Attribute(
                            ...
                            COPY("aboutDownloads.dtd", "aboutDownloads.title"),
                        ),
                        FTL.Attribute(
                            FTL.Identifier("missing"),
                            COPY("aboutDownloads.dtd", "missing"),
                        ),
                    ],
                ),
            ],
...
class TestExistingTarget(unittest.TestCase):
        ...
        self.ctx.add_transforms(
            ...
            [
                FTL.Message(
                    ...
                    value=COPY("privacy.dtd", "doNotTrack.learnMore.label"),
                ),
            ],
        )
        ...
        self.ctx.add_transforms(
            ...
            [
                FTL.Message(
                    ...
                    value=COPY("privacy.dtd", "doNotTrack.description"),
                ),
                ...
                FTL.Message(
                    ...
                    value=COPY("privacy.dtd", "doNotTrack.always.label"),
                ),
            ],
        )
    ...
    def test_existing_target_ftl_with_all_messages_reordered(self):
        self.ctx.add_transforms(
            ...
            [
                FTL.Message(
                    id=FTL.Identifier("foo"), value=COPY("existing.dtd", "foo")
                ),
                FTL.Message(
                    id=FTL.Identifier("bar"), value=COPY("existing.dtd", "bar")
                ),
            ],
        )
            ...
            [
                FTL.Message(
                    ...
                    attributes=[
                        FTL.Attribute(
                            FTL.Identifier("one"),
                            value=FTL.Pattern([FTL.TextElement("Attribute Value")]),
                        ),
                    ],
                ),
            ]
